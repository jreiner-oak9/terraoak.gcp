...
resource "google_sql_database_instance" "mysql" {
  ...
  settings {
    ...
    ip_configuration {
      ...
      require_ssl = false # oak9: settings.ip_configuration.require_ssl should be set to any of True # oak9: settings.ip_configuration.require_ssl should be set to any of True
    }
